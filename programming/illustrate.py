...
def illustrate(problem_no):
    ...
    with open('data/problem{}_global.csv'.format(problem_no), 'r') as f:
...
illustrate(1) # The first level, the second level global optimal strategy drawing
fair_game() # Game winning percentage drawing
game_sim() # Sixth level simulation data analysis
