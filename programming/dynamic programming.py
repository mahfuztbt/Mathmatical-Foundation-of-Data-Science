...
class Point:
    def __init__(self,index):
        ...
        self.type=0
        self.players=0
        # 0 1 2 3 4:  village, mine, starting point and ending point
...
class Decision:
    def __init__(self,start,end,weather,getMineral=False):
        ...
        self.water=self.food=self.money=0 # Consumption is positive, earning is negative. Water or food units are boxes
...
def loadEnvir(problem_no):
    ...
    if problem_no==1 or problem_no==2:
        WEATHER='high temperature, high temperature, sunny, sandstorm, sunny, high temperature, sandstorm, sunny, high temperature, high temperature, sandstorm, high temperature, sunny, high temperature, high temperature, high temperature, sandstorm, sandstorm, high temperature, high temperature, sunny, sunny, high temperature, sunny, sandstorm, High temperature, sunny, sunny, high temperature, high temperature'.split(',')
        DAY_NUM=30
        MAX_BURDEN=1200
        INIT_MONRY=10000
        PROFIT=1000
        ...
        FOOD_WEIGHT=2
        FOOD_PRICE=10
        WATER_CONSUMPTION={'high temperature':5,'sunny':8,'sandstorm':10}
        FOOD_CONSUMPTION={'high temperature':7,'sunny':6,'sandstorm':10}
    ...
    if problem_no==6:
        ...
        FOOD_WEIGHT=2
        FOOD_PRICE=10
        WATER_CONSUMPTION={'sunny':3,'high temperature':9,'sandstorm':10}
        FOOD_CONSUMPTION={'sunny':4,'high temperature':9,'sandstorm':10}
        POINT_NUM=25
        DESTINATION=24
        for i in range(POINT_NUM):
            POINTS.append([])
...
def dp_all(problem_no):
    # Multiple search + dynamic programming to solve the first and second levels
    ...
    for i in range(1000):
        ...
        for i in range(DAY_NUM):
            ...
            if rd<0.1:
                ...
                WEATHER.append('high temperature')
...
if __name__ == "__main__":
    dp_all(2) # solve the first and the second level
